...
### Kabila Wallet <a href="#hashpack" id="hashpack"></a>
...
## Connecting Wallets to Bonzo Finance <a href="#hashpack" id="hashpack"></a>

### **Desktop Browser + Chrome Extension Wallet (WalletConenct)**

1. From the [Bonzo Finance dashboard](./), click on "Connect Wallet" and choose HashPack or Kabila.
...
1. From the [Bonzo Finance dashboard](./) on your desktop device, click on "WalletConnect".
